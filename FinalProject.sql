...
CREATE TABLE IF NOT EXISTS `FinalProject`.`MainPerformer` (
  ...
  `Play_PlayId` INT NOT NULL,
  INDEX `fk_MainPerformer_Play1_idx` (`Play_PlayId` ASC) VISIBLE,
  CONSTRAINT `fk_MainPerformer_Play1`
    FOREIGN KEY (`Play_PlayId`)
...
CREATE TABLE IF NOT EXISTS `FinalProject`.`Booking` (
  ...
  INDEX `fk_Booking_Play1_idx` (`Play_PlayId` ASC) VISIBLE,
