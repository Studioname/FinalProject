...
public class main {
	public static void main(String[] args) {
		...
		Play p = new Play("Cats", 1, "A show about cats", "12:00:00", "2022-12-10", "02:00:00", 5000, 5000, "English", 1);
		Play p2 = new Play("Tears for Fears", 3, "Tears to Fears is suitable for everyone and will be perfoming their top hits", "18:00:00", "2022-07-04", "01:00:00", 2200, 2200, null, 1);
		...
		Booking booking = new Booking(1, 1, 1, 1, 1, 1, 1);
		Booking booking2 = new Booking(1, 2, 1, 1, 2, 2, 1);
		dbm.addBooking(booking);
		dbm.addBooking(booking2);	

		//the above is purely for testing purposes
		
		dbm.addPerformer(1, "Conan Hollands");
		dbm.addPerformer(1, "Snoo snoo Hollands");
		dbm.addPerformer(1, "Third Hollands");
		MainPerformers mainPerformers = dbm.fetchMainPerformers(dbm.searchMainPerformersByPlayId(1));
		System.out.println("Size of mainPerformers : " + mainPerformers.getMainPerformersSize());
		System.out.println("Main Performers Play Id: " + mainPerformers.getPlayId());
